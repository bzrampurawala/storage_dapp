...
contract Store{
    ...
    function shareFile(address to, bytes32 name, bytes32 hashId1, bytes32 hashId2, bytes32 typeOfFile, uint size) public{
        users[to].push(file(name,hashId1, hashId2, typeOfFile, size));
    }
